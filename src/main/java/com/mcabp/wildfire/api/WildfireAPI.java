...
public final class WildfireAPI {
    ...
    public static final String MODID = "mcabp";
     ...
     *
     * @deprecated Define gender armor via data packs. This can be created with {@link com.mcabp.wildfire.api.data.GenderArmorProvider}
     */
